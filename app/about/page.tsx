/* LLM context: Creating a high-end "Apple-style" About Page with a clean grid of experts and refined typography using Tailwind v4 and shadcn UI */
...
const experts = [
  ...
  },
  {
    ...
    image: "/images/experts/RovnoMikhail.jpg", // Placeholder using existing assets
    slug: "RovnoMikhail"
  },
  {
    name: "Данил Киткин",
    ...
    image: "/images/experts/RovnoDanil.jpg", // Placeholder using existing assets
    slug: "RovnoDanil"
  }
];
...
function ExpertCard({ expert }: { expert: typeof experts[0] }) {
  return (
    <Link href={`/${expert.slug}`} className="group block">
  ...
  return (
    <main className="min-h-screen bg-(--bg)">
      ...
      <section className="py-20 overflow-hidden opacity-30 pointer-events-none">
        <Container>
          <div className="text-[12vw] font-heading font-bold whitespace-nowrap text-(--outline) select-none">
