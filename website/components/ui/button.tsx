...
export const buttonAmorfaVariants = {
  ...
  outlined: "border border-[color-mix(in_srgb,var(--on-bg-high),transparent_70%)] bg-transparent text-foreground [&_svg]:text-current",
  ...
  // ponytail: red-tinted glass for destructive actions (delete account, etc.)
  "glass-red": "bg-[color-mix(in_srgb,var(--red-9),transparent_90%)] backdrop-blur-[var(--blur-glass)] border border-[color-mix(in_srgb,var(--red-9),transparent_60%)] text-[var(--red-9)] [&_svg]:text-current cursor-pointer",
